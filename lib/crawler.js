  ...
  var c = new Crawler({
    ...
    "callback": function(error,result,$) {
      ...
      try {
        ...
        if(getDomain(url) !== getDomain(result.window.location.href) && !opts.followForeigners) return; // don't follow foraign pages if configured...
        ...
        $("a[href]").each(function(index,a) {
          ...
          po.links.push(href); emit("reference", href, po.url);
