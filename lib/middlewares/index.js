    ...
    if(/text\/x?-?html|application\/x?-?html/.test(result.headers['content-type'])) { // && result.window.$
      ...
      $("a[href]").each(function(index,a) {
        ...
        if(target = wc.getPageObject(href)) {
          if(obj = target.getAnalysis("Expected content-type")) obj.push("*/*");
      ...
      $("script[src]").each(function(index, script){
        ...
        var target, obj;
        if(target = wc.getPageObject(href)) {
          if(obj = target.getAnalysis("Expected content-type")) obj.push("text/javascript, application/x-javascript");
      ...
      $('link[rel="stylesheet"]').each(function(index, link){
        ...
        var target, obj;
        if(target = wc.getPageObject(href)) {
          if(obj = target.getAnalysis("Expected content-type")) obj.push("text/css");
      ...
      $('img[href]').each(function(index, img){
        ...
        var target, obj;
        if(target = wc.getPageObject(href)) {
          if(obj = target.getAnalysis("Expected content-type")) obj.push("image/*");
